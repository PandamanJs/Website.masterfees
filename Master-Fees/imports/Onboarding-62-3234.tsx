    ...
    >
      <div className="flex flex-col font-['IBM_Plex_Sans_Devanagari:Regular',_sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[#000000] text-[16px] text-center w-full">
        <p className="block leading-[20px]">
          Would you like to Group your classes? Create Product Groups. For
          example, Early Childhood, Lower Primary, JuniorSecondary, Senior
...
function Frame1707478787() {
  return (
    <div
      className="absolute bg-[#003049] box-border content-stretch flex flex-row gap-2.5 items-center justify-center px-8 py-2.5 rounded-[10px] top-[665px] translate-x-[-50%]"
      style={{ left: "calc(50% + 0.5px)" }}
    >
