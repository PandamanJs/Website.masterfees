function Frame1707478689() {
  return (
    <div
      className="absolute box-border content-stretch flex flex-col gap-2 items-start justify-start p-0 top-[484px] translate-x-[-50%] w-[871px]"
...
function Frame1707478788() {
  return (
    <div
      className="absolute box-border content-stretch flex flex-col gap-2 items-start justify-start p-0 top-[170px] translate-x-[-50%] w-[871px]"
      style={{ left: "calc(50% - 0.5px)" }}
    >
      <div className="flex flex-col font-['IBM_Plex_Sans_Devanagari:Regular',_sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[#000000] text-[16px] text-center w-full">
        <p className="block leading-[20px]">
          Select/ Deselect the Grades that your school offers
        </p>
      </div>
      <div className="h-[245px] relative rounded-lg shrink-0 w-full">
        <div className="absolute border border-[#9ca0a4] border-solid inset-0 pointer-events-none rounded-lg" />
      </div>
    </div>
  );
...
function Frame1707478690() {
  return (
    <div
      className="absolute box-border content-stretch flex flex-col gap-2 items-start justify-start p-0 top-[579px] translate-x-[-50%] w-[871px]"
      style={{ left: "calc(50% - 0.5px)" }}
    >
      <div className="flex flex-col font-['IBM_Plex_Sans_Devanagari:Regular',_sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[#000000] text-[16px] text-center w-full">
        <p className="block leading-[20px]">
          Are There Any grades that the previous number does not apply to
        </p>
      </div>
      <div className="h-[57px] relative rounded-lg shrink-0 w-full">
        <div className="absolute border border-[#9ca0a4] border-solid inset-0 pointer-events-none rounded-lg" />
...
function Frame1707478787() {
  return (
    <div
      className="absolute bg-[#003049] box-border content-stretch flex flex-row gap-2.5 items-center justify-center px-8 py-2.5 rounded-[10px] top-[684px] translate-x-[-50%]"
