        ...
        <div className="w-full max-w-md space-y-8">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  className="w-full px-4 py-3 bg-[#2a3441] border border-gray-600 rounded-lg text-white placeholder-gray-400 focus:outline-none focus:border-[#5DFCAF] focus:ring-1 focus:ring-[#5DFCAF] transition-colors"
                  required
                />
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center">
                <input
                  ...
                  className="h-4 w-4 text-[#5DFCAF] focus:ring-[#5DFCAF] border-gray-600 rounded bg-[#2a3441]"
                />
            ...
            <button
              type="button"
              onClick={onSignup}
              className="w-full flex justify-center py-3 px-4 border border-gray-600 rounded-lg shadow-sm text-sm font-medium text-white bg-transparent hover:bg-[#2a3441] focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500 focus:ring-offset-[#1a2332] transition-colors"
            >
      ...
      <div className="flex-1 bg-[#f8f9fa] p-8 flex items-center justify-center">
        <div className="max-w-md text-center">
          ...
          <div className="mb-8 flex justify-center">
            <div className="w-20 h-20 bg-[#1a2332] rounded-lg transform rotate-45 flex items-center justify-center">
              <div className="w-8 h-8 border-2 border-[#5DFCAF] rounded transform -rotate-45"></div>
            </div>
          </div>
          ...
          <div className="space-y-4 text-left">
            <div className="flex items-start">
              <div className="flex-shrink-0 w-5 h-5 bg-[#5DFCAF] rounded-full flex items-center justify-center mt-0.5 mr-3">
                <svg className="w-3 h-3 text-white" fill="currentColor" viewBox="0 0 20 20">
                  <path fillRule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clipRule="evenodd" />
                </svg>
              </div>
              <div>
                <p className="text-gray-700 font-medium">Real-time fee tracking and payment monitoring</p>
              </div>
            </div>
            ...
            <div className="flex items-start">
              ...
              <div>
                <p className="text-gray-700 font-medium">Comprehensive student and parent management</p>
              </div>
            </div>
            ...
            <div className="flex items-start">
              ...
              <div>
                <p className="text-gray-700 font-medium">Automated reports and financial analytics</p>
              </div>
            </div>
            ...
            <div className="flex items-start">
              ...
              <div>
                <p className="text-gray-700 font-medium">QuickBooks integration for seamless accounting</p>
              </div>
            </div>
          </div>
        </div>
